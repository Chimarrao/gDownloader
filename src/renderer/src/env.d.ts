...
interface RendererApi {
  ...
  modules: {
    ...
    cachedFileInfo: (
      moduleId: string,
      url: string,
    ) => Promise<CachedFileInfoSnapshot | null>;
  ...
  torrents: {
    ...
    list: () => Promise<TorrentStatus[]>;
    get: (id: string) => Promise<TorrentStatus | null>;
    pause: (id: string) => Promise<void>;
    resume: (id: string) => Promise<void>;
    recheck: (id: string) => Promise<void>;
    remove: (id: string, deleteFiles: boolean) => Promise<void>;
    selectFiles: (id: string, indices: number[]) => Promise<void>;
    peers: (id: string) => Promise<TorrentPeerStatus[]>;
