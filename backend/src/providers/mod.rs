...
/// Junta os arquivos-parte no destino final usando ~1x de espaço em disco: renomeia
/// a 1ª parte para um temporário `.merging` e vai ANEXANDO + APAGANDO as demais (em
